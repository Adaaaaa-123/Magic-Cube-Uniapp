<template>
	<view class="container">
		<u-navbar title="电子围栏" :autoBack="true"></u-navbar>
		<view class="formBlock">
			<uni-forms class="formBox" ref="valiForm" :rules="rules" :modelValue="formData" label-width="80px">
				...
				<uni-forms-item label="IMSI" required name="imsi">
					<uni-easyinput v-model="formData.imsi" placeholder="请输入imsi地址" />
				</uni-forms-item>
				<uni-forms-item label="IMEI" required name="imei">
					<uni-easyinput v-model="formData.imei" placeholder="请输入imei地址" />
				</uni-forms-item>
			...
			return {
				...
				rules: {
					...
					imsi: {
						rules: [{
							required: true,
							errorMessage: '请输入imsi地址'
						}]
					},
					imei: {
						rules: [{
							required: true,
							errorMessage: '请输入imei地址'
						}]
					},
					level: {
						rules: [{
